...
CliRunner.prototype = {
  ...
  initTestSettings : function(env, settings) {
    ...
    // expose the tag_filter and debug to underlying test suites via an environment variable
    process.env.__NIGHTWATCH_TAG_FILTER = this.test_settings.tag_filter;
    process.env.__NIGHTWATCH_TAG_DEBUG = this.test_settings.debug;
